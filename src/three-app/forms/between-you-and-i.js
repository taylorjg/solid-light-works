...
export class BetweenYouAndIForm {
  ...
  getStraightLinePoints(cycleRatio) {
    ...
    return [new THREE.Vector2(px, py), new THREE.Vector2(-px, -py)];
  }
  ...
  getFootprintData(deltaMs, absoluteMs) {
    ...
    const scene1WipeClippingPlane = this.wipingInEllipse
      ? wipingInClippingPlane
      : wipingOutClippingPlane;
    const scene2WipeClippingPlane = this.wipingInEllipse
      ? wipingOutClippingPlane
      : wipingInClippingPlane;
