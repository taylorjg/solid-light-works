...
export class BreathIIForm {
  ...
  getFootprintData(deltaMs, absoluteMs) {
    ...
    const configureWaveA = () => {
      ...
      const waveYDerivativeFn = parametricTravellingWaveYDerivative(A, k, ωt, φ)
      return {
        waveXFn,
        waveYFn,
        waveXDerivativeFn,
    ...
    const intersectionEndXGuesses = { t1: THREE.MathUtils.degToRad(-180), t2: 0 }
    ...
    const intersectionPointEndXWaveA = new THREE.Vector2(outerSkinXFn(intersectionEndXWaveA.t1), outerSkinYFn(intersectionEndXWaveA.t1))
    const intersectionPointEndXWaveB = new THREE.Vector2(outerSkinXFn(intersectionEndXWaveB.t1), outerSkinYFn(intersectionEndXWaveB.t1))
    const intersectionPointEndYWaveA = new THREE.Vector2(outerSkinXFn(intersectionEndYWaveA.t1), outerSkinYFn(intersectionEndYWaveA.t1))
    const intersectionPointEndYWaveB = new THREE.Vector2(outerSkinXFn(intersectionEndYWaveB.t1), outerSkinYFn(intersectionEndYWaveB.t1))
