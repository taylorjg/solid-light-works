...
export const config = {
  ...
  config3D: {
    cameraPoses: [
      {
        position: new THREE.Vector3(4.44, 3.43, 13.7),
        target: new THREE.Vector3(1.2, 2.0, 9.48),
      },
      {
        position: new THREE.Vector3(-3.62, 4.46, 23.05),
        target: new THREE.Vector3(1.08, 3.34, 9.27),
      },
      {
        position: new THREE.Vector3(0.11, -7.74, 6.39),
        target: new THREE.Vector3(-0.32, 1.65, 6.39),
        isBehind: true,
      },
    ],
    scenery: [new Floor(10, 13)],
  },
};
