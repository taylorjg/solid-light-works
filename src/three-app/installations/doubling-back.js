...
export const config = {
  ...
  config3D: {
    cameraPoses: [
      {
        position: new THREE.Vector3(-0.85, 7.31, 17.0),
        target: new THREE.Vector3(-0.8, 2.0, 5.5),
      },
      {
        position: new THREE.Vector3(4.18, 4.64, 12.76),
        target: new THREE.Vector3(-0.8, 2, 5.5),
      },
      {
        position: new THREE.Vector3(1.3, 2, -6),
